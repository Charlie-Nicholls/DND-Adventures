- Spaceship named Pandora
	...
	- Can also mention there are two versions of the myth, one where the box has all the evils of the world + hope that Pandora releases on purpose and one where it contains a collection of blessings from the gods that all escape - except hope - given to Pandora and released by a curious man.
